...
public class CucumberWithPropertiesForRestApi extends CucumberWithProperties {

    public CucumberWithPropertiesForRestApi(Class<?> clazz) throws InitializationError, IOException {
        super(clazz);
        setupDI();
    }
